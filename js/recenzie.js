document.querySelector("#adrecenzie").onclick = function (event) {  
   ...
   xhtp.open("POST", "recenzie.php");  //  Va deveni "recenzie.php"!
   ...
   var continutbloc = '<p class="text-center citeste"><strong>{nume}</p><p> Mulțumim pentru recenzia scrisă de dvs. Opiniile trimise de dvs. sunt importante pentru noi, în menținerea standardelor de calitate.</p></br><div class="row justify-content-md-center actiuni"> <a href="citeste.html">citeste recenziile</a></div>';
